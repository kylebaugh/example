...
let nameGreeting = nameCheck('Kyle')
...
let colorRating = faveColorFinder('asdf')
...
function theEliminator(arr, person1){
  let arr1 = arr
...
function upperKylo(string){
  console.log(string.toUpperCase())
}

upperKylo(sampleString)
...
function emailCheck(email){
  ...
  let validEmail = emailString.trim()
...
let totalFrogs = frogger(17)
console.log(totalFrogs)

////////////////// PROBLEM 14 ////////////////////
/*
  You might have noticed a slight bug in problem 12. If you were to pass in 4 gold, the function would return to you 
  1.3333... However, you can't really go to a store and by 1.333 products. You would just be able to purchase 1 product. 
...
console.log(frogger2(23))

////////////////// PROBLEM 15 ////////////////////
let sampleArray = [0,1,2,3,4,7,5,6,8,9]
/*
  Write a function that takes in an array of numbers as an argument. In the body of the function, write logic to 
  determine if the array is in ascending order. The function should return true, if it is sorted in ascending order, 
...
let bathroomScope = ['duck', 'squeaky']

//This array should contain the variable names (as strings) accessible in the bathtub function.
let bathtubScope = ['duck', 'squeaky', 'nautical']
